...
export function AssistantDialog({
  ...
  function navigateFor(action: AssistantAction): boolean {
    ...
    switch (action.type) {
      case 'train':
        navigationRef.navigate('TrainsTab', {
          screen: 'TrainDetails',
          params: { trainNumber: action.trainNumber },
        } as never);
        return true;
      case 'station':
        navigationRef.navigate('StationsTab', {
          screen: 'StationDetails',
          params: { stationCode: action.stationCode },
        } as never);
        return true;
      case 'journey':
        navigationRef.navigate('JourneysTab', {
          screen: 'JourneySearch',
          params: { from: action.from, to: action.to },
        } as never);
        return true;
      case 'home':
          ...
          renderItem={({ item }) => (
            <View
              style={[
                ...
                item.role === 'user'
                  ? styles.userBubble
                  : { backgroundColor: palette.assistantBubble, alignSelf: 'flex-start' },
              ]}
            >
              <Text
                style={item.role === 'user' ? styles.userText : { color: palette.assistantText }}
              >
                {item.content}
              </Text>
            </View>
