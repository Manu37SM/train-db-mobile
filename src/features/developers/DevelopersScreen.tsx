...
const ENDPOINTS: Endpoint[] = [
  {
    ...
    description:
      'Search trains by number or name. Falls back to a typo-tolerant fuzzy match if there are no exact results.',
  ...
  },
  {
    ...
    description:
      'Full route for one train: every stop with arrival/departure time, distance, and halt duration.',
  ...
  },
  {
    ...
    description:
      "A station's originating, terminating, and passing-through trains, with arrival/departure times.",
  ...
  },
  {
    ...
    description:
      'Every direct train between two stations, sorted fastest-first, with distance and duration for each.',
  ...
  },
  {
    ...
    path: '/stats',
    description:
      'Dataset-wide statistics: total trains/stations, longest/shortest routes, fastest/slowest trains, and busiest stations.',
  ...
  return (
    <ScrollView contentContainerStyle={styles.content}>
      ...
      <Text style={styles.intro}>
        RailLens's train/station/journey search data is available as a public, read-only REST API —
        the same one this app itself calls.
      </Text>
